<div class="flex flex-col mx-auto max-w-5xl pt-2 px-4 sm:px-8 gap-14">
    <div class="flex justify-around">
        <div class="flex flex-col items-center gap-4">
            <h2 class="text-king-600 text-lg font-bold">Recette</h2>
            <div class="flex flex-col items-center">
                <p class="text-emerald-600 font-medium">2500€</p>
                <p class="text-king-600 font-medium text-xs">pour ce mois</p>
            </div>
        </div>
        <div class="flex flex-col items-center gap-4">
            <h2 class="text-king-600 text-lg font-bold">Salaire</h2>
            <p class="text-emerald-600 font-medium">1500€</p>
        </div>
        <div class="flex flex-col items-center gap-4">
            <h2 class="text-king-600 text-lg font-bold">Epargne</h2>
            <div class="flex flex-col items-center">
                <p class="text-emerald-600 font-medium">2500€</p>
                <p class="text-king-500 font-medium text-xs">pour ce mois</p>
            </div>
        </div>
    </div>
    <div class="flex justify-around">
        <a href="{{ route('trades-list') }}" class="{{ request()->routeIs('trades-list') ? 'border-king-600' : 'border-transparent' }} border-b-2 relative px-3 py-2 text-king-600">
            <svg width="32" height="32" viewBox="0 0 20 20"><path fill="currentColor" stroke-width="0.5" stroke="#151850" d="M7.354 13.854L9 12.207a.5.5 0 1 0-.707-.707l-.793.793V6.5a.5.5 0 0 0-1 0v5.793l-.793-.793a.5.5 0 1 0-.707.707l1.646 1.647a.5.5 0 0 0 .708 0ZM15 7.793l-1.646-1.647a.5.5 0 0 0-.708 0L11 7.793a.5.5 0 1 0 .707.707l.793-.793V13.5a.5.5 0 1 0 1 0V7.707l.793.793A.5.5 0 1 0 15 7.793ZM18 10a8 8 0 1 1-16 0a8 8 0 0 1 16 0Zm-8 7a7 7 0 1 0 0-14a7 7 0 0 0 0 14Z"/></svg>
        <a href="{{ route('trade-store', ['trade_id' => 'new']) }}" class="{{ request()->routeIs('trade-store') ? 'border-king-600' : 'border-transparent' }} border-b-2 relative px-3 py-2 text-king-600">
        ...
        <a href="#" class="relative px-3 py-2 text-king-600">
