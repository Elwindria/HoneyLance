<div class="flex flex-col mx-auto max-w-5xl pt-6 px-4 sm:px-8 gap-4">
    ...
    <div class="flex justify-around">
        <a href="{{ route('trades-list') }}" class="{{ request()->routeIs('trades-list') ? 'border-white' : 'border-transparent' }} border-b-2 relative px-3 py-2 text-white">
        ...
        <a href="{{ route('trade-store', ['trade_id' => null]) }}" class="{{ Str::contains($this->url, 'trade/') || Str::endsWith($this->url, 'trade') ? 'border-white' : 'border-transparent' }} border-b-2 relative px-3 py-2 text-white">
        ...
        <a href="#" class="relative px-3 py-2 text-white">
