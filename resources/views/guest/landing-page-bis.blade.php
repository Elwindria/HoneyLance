<x-guest-layout>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                <div class="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900">Gérer votre <span class="inline-block px-2 py-1 relative bg-honey text-white" style="border-radius: 91% 9% 90% 10% / 29% 82% 18% 71%">salaire</span></h1>
                    <h1 class="text-2xl font-semibold tracking-tight text-gray-900">de freelance n'aura jamais été aussi facile 💖</h1>
                    <p class="mt-6 text-lg text-gray-600">Ne vous laissez plus submerger par votre compta ! Avec <strong>Honeylance</strong>, vous savez exactement où vous en êtes dans vos comptes et ce que vous pouvez vous <strong>verser comme salaire</strong> ce mois-ci 😀</p>
                        ...
                        <svg viewBox="0 0 1026 1026" fill="none" aria-hidden="true" class="absolute inset-0 h-full w-full animate-spin-slow">
                            ...
                            <defs>
                                <linearGradient id=":R65m:-gradient-1" x1="1" y1="513" x2="1" y2="1025" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#FFC96B"></stop>
                                    <stop offset="1" stop-color="#FFC96B" stop-opacity="0"></stop>
                                </linearGradient>
                            </defs>
                        </svg>
                        ...
                        <div class="relative aspect-[366/729] mx-auto max-w-[366px]">
                            ...
                            <div class="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-white pt-[calc(23/318*100%)]">
                                ...
                                <div class="flex flex-col">
                                    <nav class="relative z-30 rounded-b-3xl bg-white">
                                        <div class="mx-auto max-w-7xl px-3 relative z-50 flex justify-between py-3 ">
                                            ...
                                            <div class="relative inline-block text-left">
                                                <div>
                                                    <button type="button" aria-label="menu" class="relative group flex p-1 items-center rounded-full text-king hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-honey focus:ring-offset-2 focus:ring-offset-honey">
                                    ...
                                    <div class="flex flex-col w-full mx-auto px-4 pt-10 gap-4 bg-honey/10 -mt-4">
                                        <div class="flex justify-between">
                                            <div class="flex flex-col items-center">
                                                <h2 class="text-king text-lg font-bold">Recette</h2>
                                                <div class="flex flex-col items-center">
                                                    <p class="text-emerald-600 font-medium">{{ number_format(2300, 0, ',', ' ') }} €</p>
                                                    <p class="text-honey-dark/80 font-thin text-xs -mt-2">mois en cours</p>
                                                </div>
                                            </div>
                                            <a href="#" class="flex flex-col items-center">
                                                <h2 class="text-king text-lg font-bold">Salaire</h2>
                                                <p class="text-emerald-600 font-medium">{{ number_format(1200, 0, ',', ' ') }} €</p>
                                            </a>
                                            <div class="flex flex-col items-center">
                                                <h2 class="text-king text-lg font-bold" wire:click="sendMail">Epargne</h2>
                                                <div class="flex flex-col items-center">
                                                    <p class="text-emerald-600 font-medium">{{ number_format(900, 0, ',', ' ') }} €</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex justify-around">
                                            <a href="#" class="border-honey-dark border-b-2  px-3 py-2 text-honey-dark" aria-label="Display trade list">
                                            ...
                                            <a href="#" class="border-transparent border-b-2  px-3 py-2 text-honey-dark" aria-label="Add a new trade">
                                            ...
                                            <a href="#" class="border-transparent border-b-2 px-3 py-2 text-honey-dark" aria-label="Display criticals informations">
                                    ...
                                    <div class="relative bg-honey/10">

                                        <div class="flex flex-col gap-4 mt-2 pt-6 pb-2 mb-2 mx-auto max-w-7xl px-4 sm:px-8 sticky -top-1 bg-white rounded-t-3xl z-40">
                                            <div class="flex justify-center">
                                                <div class="relative">
                                                    <input class="block w-full text-center appearance-none rounded-3xl pt-1 pb-2 border-honey border-2 h-8 bg-white focus:ring focus:ring-honey-light/50 focus:border-transparent text-king" placeholder="rechercher..." type="search" style="caret-color: rgb(107, 114, 128);" tabindex="0">
                                                </div>
                                            </div>
                                            <div class="flex justify-between">
                                                <button class="text-king-light border-king-light border-b hover:border-king-light hover:text-king-light px-3 py-2 font-medium text-sm">Tout</button>
                                                <button class="text-king/50 border-white border-b hover:border-king-light hover:text-king-light px-3 py-2 font-medium text-sm">Entrée</button>
                                                <button class="text-king/50 border-white border-b hover:border-king-light hover:text-king-light px-3 py-2 font-medium text-sm">Sortie</button>
                                                <button class="text-king/50 border-white border-b hover:border-king-light hover:text-king-light px-3 py-2 font-medium text-sm">Frais Fixe</button>
                                            </div>
                                        </div>

                                        <div class="mx-auto max-w-7xl px-2 pt-4 -mt-4 bg-white">

                                            <div class="flex flex-col justify-center gap-2">

                                                <a href="#" class="flex items-center justify-between gap-3 bg-white p-2 border-king hover:border-honey hover:bg-gray-100 rounded-3xl border-2">
                                                    <div class="flex-none">
                                                    ...
                                                    <div class="flex-1">
                                                        <p class="text-king font-bold capitalize text-base">Lorem Ipsum</p>
                                                        <div class="flex gap-1 flex-wrap">
                                                            <div class="bg-honey-light/60 text-xs text-honey-dark py-0.5 px-1.5 rounded-md whitespace-nowrap">tag 1</div>
                                                            <div class="bg-honey-light/60 text-xs text-honey-dark py-0.5 px-1.5 rounded-md whitespace-nowrap">tag 2</div>
                                                        </div>
                                                    </div>
                                                    <div class='shrink-0 flex justify-end items-center gap-4'>
                                                        <p class="text-king-light text-lg font-bold">{{ number_format(1200, 2, ',', ' ') }} €</p>
                                                        <div class="text-king">
                                                ...
                                                <a href="#" class="flex items-center justify-between gap-3 bg-white p-2 border-king hover:border-honey hover:bg-gray-100 rounded-3xl border-2">
                                                    ...
                                                    <div class="flex-1">
                                                        <p class="text-king font-bold capitalize text-base">Ipsum Lorem</p>
                                                        <div class="flex gap-1 flex-wrap">
                                                            <div class="bg-honey-light/60 text-xs text-honey-dark py-0.5 px-1.5 rounded-md whitespace-nowrap">tag 1</div>
                                                            <div class="bg-honey-light/60 text-xs text-honey-dark py-0.5 px-1.5 rounded-md whitespace-nowrap">tag 2</div>
                                                        </div>
                                                    ...
                                                    <div class='shrink-0 flex justify-end items-center gap-4'>
                                                        <p class="text-king-light text-lg font-bold">{{ number_format(200, 2, ',', ' ') }} €</p>
                                                        <div class="text-king">
                                                            <svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <rect x="1.41431" width="10" height="2" rx="1" transform="rotate(45 1.41431 0)" fill="currentColor" />
                                                                <rect y="13.071" width="10" height="2" rx="1" transform="rotate(-45 0 13.071)" fill="currentColor" />
                            ...
                            <img alt="" src="https://pocket.tailwindui.com/_next/static/media/phone-frame.d4b6b62a.svg" width="366" height="729" decoding="async" data-nimg="1" class="pointer-events-none absolute inset-0 h-full w-full" style="color:transparent">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="features" aria-label="Features for investing all your money" class="bg-gray-900 py-20 sm:py-32">
        ...
        <div class="mt-16 md:hidden">
            <div class="-mb-4 flex snap-x snap-mandatory -space-x-4 overflow-x-auto overscroll-x-contain scroll-smooth pb-4 sm:-space-x-6">
                <div class="w-full flex-none snap-center px-4 sm:px-6">
                    <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                        ...
                        <div class="relative aspect-[366/729] mx-auto w-full max-w-[366px]">
                                        ...
                                        <div class="px-4 py-6">
                                            <div class="space-y-6">
                                                <div>
                                                    ...
                                                    <div class="mt-2 border-b border-gray-200 pb-2 text-sm text-gray-900">Albert H. Wiggin</div>
                                                </div>
                                                <div>
                                                    <div class="text-sm text-gray-500">Email address</div>
                                                    <div class="mt-2 border-b border-gray-200 pb-2 text-sm text-gray-900">awiggin@chase.com</div>
                                                </div>
                                            </div>
                                            <div class="mt-6 rounded-lg bg-cyan-500 py-2 px-3 text-center text-sm font-semibold text-white">Invite person</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <img alt="" src="https://pocket.tailwindui.com/_next/static/media/phone-frame.d4b6b62a.svg" width="366" height="729" decoding="async" data-nimg="1" class="pointer-events-none absolute inset-0 h-full w-full" loading="lazy" style="color:transparent">
                        </div>
                ...
                <div class="w-full flex-none snap-center px-4 sm:px-6">
                    <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg viewBox="0 0 558 558" width="558" height="558" fill="none" aria-hidden="true" class="rotate-180">
                                <defs>
                                ...
                                <path opacity=".2" d="M1 279C1 125.465 125.465 1 279 1s278 124.465 278 278-124.465 278-278 278S1 432.535 1 279Z" stroke="#13B5C8"></path>
                                <path d="M1 279C1 125.465 125.465 1 279 1" stroke="url(#:R369m:)" stroke-linecap="round"></path>
                            </svg>
                        </div>
                        <div class="relative aspect-[366/729] mx-auto w-full max-w-[366px]">
                            <div class="absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)] shadow-2xl"></div>
                                ...
                                <div class="flex flex-col w-full">
                                    ...
                                    <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                                        <div class="divide-y divide-gray-100">
                                            ...
                                            <div class="flex items-center gap-4 px-4 py-3">
                                                <div class="flex-none rounded-full" style="background-color:#5A67D8"><svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M22.5 8 12 11.692v12l3.5 1.231v3.385L26 32V12.615l-3.5 1.231V8Zm-5.833 17.334 5.833 2.05v-12.24l2.333-.82v15.968l-8.166-2.87v-2.088Z"></path>
                                                    </svg></div>
                                            ...
                                            <div class="flex items-center gap-4 px-4 py-3">
                                                <div class="flex-none rounded-full" style="background-color:#2A5B94"><svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" class="h-10 w-10">
                                            ...
                                            <div class="flex items-center gap-4 px-4 py-3">
                                                <div class="flex-none rounded-full" style="background-color:#3320A7"><svg viewBox="0 0 40 40" fill="#fff" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="h-10 w-10">
                                            ...
                                            <div class="flex items-center gap-4 px-4 py-3">
                                                <div class="flex-none rounded-full" style="background-color:#2A3034"><svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" class="h-10 w-10">
                                            ...
                                            <div class="flex items-center gap-4 px-4 py-3">
                                                <div class="flex-none rounded-full" style="background-color:#8D8D8D"><svg viewBox="0 0 40 40" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="square" stroke-linejoin="round" aria-hidden="true" class="h-10 w-10">
                ...
                <div class="w-full flex-none snap-center px-4 sm:px-6">
                    <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg viewBox="0 0 558 558" width="558" height="558" fill="none" aria-hidden="true">
                                <defs>
                                ...
                                <path opacity=".2" d="M1 279C1 125.465 125.465 1 279 1s278 124.465 278 278-124.465 278-278 278S1 432.535 1 279Z" stroke="#13B5C8"></path>
                                <path d="M1 279C1 125.465 125.465 1 279 1" stroke="url(#:R3m9m:)" stroke-linecap="round"></path>
                            </svg>
                        </div>
                        <div class="relative aspect-[366/729] mx-auto w-full max-w-[366px]">
                            <div class="absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)] shadow-2xl"></div>
                            <div class="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                                <div class="flex flex-col w-full">
                                    <div class="flex justify-between px-4 pt-4"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true" class="h-6 w-6 flex-none">
                                            <path d="M5 6h14M5 18h14M5 12h14" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg><svg viewBox="0 0 79 24" fill="none" aria-hidden="true" class="h-6 flex-none">
                                            <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12ZM2.4 12a9.004 9.004 0 0 0 6.055 8.507c1.565.542 2.945-.85 2.945-2.507V6c0-1.657-1.38-3.049-2.945-2.507A9.004 9.004 0 0 0 2.4 12Z" fill="#06B6D4"></path>
                                            <path d="M33.004 17V6.818h3.818c.783 0 1.439.146 1.97.438.533.291.935.692 1.207 1.203.275.507.413 1.084.413 1.73 0 .653-.138 1.233-.413 1.74a2.948 2.948 0 0 1-1.218 1.198c-.537.288-1.198.433-1.983.433h-2.531v-1.517h2.282c.457 0 .832-.08 1.124-.238.291-.16.507-.378.646-.657.142-.278.214-.598.214-.96 0-.36-.072-.679-.214-.954a1.452 1.452 0 0 0-.651-.641c-.292-.156-.668-.234-1.129-.234h-1.69V17h-1.845Zm12.152.15c-.746 0-1.392-.165-1.939-.493a3.343 3.343 0 0 1-1.273-1.377c-.298-.59-.447-1.28-.447-2.068 0-.79.15-1.48.447-2.073a3.335 3.335 0 0 1 1.273-1.383c.547-.328 1.193-.492 1.94-.492.745 0 1.391.164 1.938.492.547.329.97.79 1.268 1.383.301.593.452 1.284.452 2.073 0 .789-.15 1.478-.452 2.068a3.309 3.309 0 0 1-1.268 1.377c-.547.328-1.193.492-1.939.492Zm.01-1.443c.404 0 .742-.11 1.014-.333.272-.225.474-.527.607-.905.136-.377.204-.798.204-1.262 0-.468-.068-.89-.204-1.268a2.007 2.007 0 0 0-.607-.91c-.272-.225-.61-.338-1.014-.338-.414 0-.759.113-1.034.338a2.041 2.041 0 0 0-.612.91 3.81 3.81 0 0 0-.198 1.268c0 .464.066.885.198 1.262.136.378.34.68.612.905.275.222.62.333 1.034.333Zm8.508 1.442c-.763 0-1.417-.167-1.964-.502a3.352 3.352 0 0 1-1.258-1.387c-.292-.593-.437-1.276-.437-2.048 0-.776.149-1.46.447-2.054a3.34 3.34 0 0 1 1.263-1.392c.547-.334 1.193-.502 1.939-.502.62 0 1.168.115 1.645.343.48.226.864.546 1.149.96.285.41.447.891.487 1.441h-1.72a1.644 1.644 0 0 0-.497-.92c-.259-.248-.605-.372-1.04-.372-.367 0-.69.1-.969.298-.278.196-.495.478-.651.845-.153.368-.229.81-.229 1.323 0 .52.076.968.229 1.342.152.371.366.658.641.86.279.2.605.298.98.298.265 0 .502-.05.71-.149.213-.102.39-.25.532-.442.143-.192.24-.426.294-.701h1.72a2.999 2.999 0 0 1-.477 1.437c-.275.414-.65.739-1.124.974-.474.232-1.03.348-1.67.348Zm6.39-2.545-.006-2.173h.289l2.744-3.067h2.103l-3.376 3.758h-.372l-1.383 1.482ZM58.422 17V6.818h1.8V17h-1.8Zm4.792 0-2.485-3.475 1.213-1.268L65.368 17h-2.153Zm6.245.15c-.766 0-1.427-.16-1.984-.478a3.233 3.233 0 0 1-1.278-1.362c-.298-.59-.447-1.285-.447-2.083 0-.786.149-1.475.447-2.069a3.384 3.384 0 0 1 1.263-1.392c.54-.334 1.175-.502 1.904-.502.47 0 .915.076 1.333.229.42.149.792.381 1.113.696.325.315.58.716.766 1.203.186.484.278 1.06.278 1.73v.552h-6.259v-1.213h4.534a1.935 1.935 0 0 0-.224-.92 1.625 1.625 0 0 0-.611-.641 1.719 1.719 0 0 0-.905-.234c-.368 0-.691.09-.97.269a1.848 1.848 0 0 0-.65.696c-.153.285-.231.598-.234.94v1.058c0 .444.08.825.243 1.144.163.315.39.556.681.726.292.165.634.248 1.025.248.261 0 .498-.036.71-.11.213-.075.397-.187.552-.332.156-.146.274-.327.353-.542l1.68.189a2.62 2.62 0 0 1-.606 1.163 2.958 2.958 0 0 1-1.133.766c-.461.179-.988.268-1.581.268Zm8.731-7.786v1.392h-4.39V9.364h4.39Zm-3.306-1.83h1.8v7.17c0 .241.036.427.109.556a.59.59 0 0 0 .298.258c.123.047.259.07.408.07.113 0 .215-.008.308-.025.096-.016.17-.031.219-.045l.303 1.407c-.096.034-.233.07-.412.11-.176.04-.392.063-.647.07a2.934 2.934 0 0 1-1.218-.204 1.895 1.895 0 0 1-.86-.706c-.209-.319-.311-.716-.308-1.194V7.534Z" fill="#fff"></path>
                                        </svg><svg viewBox="0 0 24 24" fill="none" aria-hidden="true" class="h-6 w-6 flex-none">
                                            <path d="M15 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM6.696 19h10.608c1.175 0 2.08-.935 1.532-1.897C18.028 15.69 16.187 14 12 14s-6.028 1.689-6.836 3.103C4.616 18.065 5.521 19 6.696 19Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg></div>
                                    <div class="mt-6 px-4 text-white">
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div class="flex justify-between border-b border-gray-100 pb-4">
                                                    ...
                                                    <div class="text-sm font-semibold text-gray-900">
                                                        <div class="flex">$34.28
                                                            <svg viewBox="0 0 24 24" fill="none" class="h-6 w-6">
                                                                <path d="M17 15V7H9M17 7 7 17" stroke="#06B6D4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            </svg>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="rounded-lg bg-cyan-500 py-2 px-3 text-center text-sm font-semibold text-white">Buy shares</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div><svg viewBox="0 0 366 729" aria-hidden="true" class="pointer-events-none absolute inset-0 h-full w-full fill-gray-100">
                                <path fill="#F2F2F2" fill-rule="evenodd" clip-rule="evenodd" d="M300.092 1c41.22 0 63.223 21.99 63.223 63.213V184.94c-.173.184-.329.476-.458.851.188-.282.404-.547.647-.791.844-.073 2.496.257 2.496 2.157V268.719c-.406 2.023-2.605 2.023-2.605 2.023a7.119 7.119 0 0 1-.08-.102v394.462c0 41.213-22.001 63.212-63.223 63.212h-95.074c-.881-.468-2.474-.795-4.323-.838l-33.704-.005-.049.001h-.231l-.141-.001c-2.028 0-3.798.339-4.745.843H66.751c-41.223 0-63.223-21.995-63.223-63.208V287.739c-.402-.024-2.165-.23-2.524-2.02v-.973A2.039 2.039 0 0 1 1 284.62v-47.611c0-.042.001-.084.004-.126v-.726c0-1.9 1.652-2.23 2.496-2.157l.028.028v-16.289c-.402-.024-2.165-.23-2.524-2.02v-.973A2.039 2.039 0 0 1 1 214.62v-47.611c0-.042.001-.084.004-.126v-.726c0-1.9 1.652-2.23 2.496-2.157l.028.028v-26.041a2.26 2.26 0 0 0 .093-.236l-.064-.01a3.337 3.337 0 0 1-.72-.12l-.166-.028A2 2 0 0 1 1 135.62v-24.611a2 2 0 0 1 1.671-1.973l.857-.143v-44.68C3.528 22.99 25.53 1 66.75 1h233.341ZM3.952 234.516a5.481 5.481 0 0 0-.229-.278c.082.071.159.163.228.278Zm89.99-206.304A4.213 4.213 0 0 0 89.727 24H56.864C38.714 24 24 38.708 24 56.852v618.296C24 693.292 38.714 708 56.864 708h250.272c18.15 0 32.864-14.708 32.864-32.852V56.852C340 38.708 325.286 24 307.136 24h-32.864a4.212 4.212 0 0 0-4.213 4.212v2.527c0 10.235-8.3 18.532-18.539 18.532H112.48c-10.239 0-18.539-8.297-18.539-18.532v-2.527Z"></path>
                                <rect x="154" y="29" width="56" height="5" rx="2.5" fill="#D4D4D4"></rect>
                            </svg><img alt="" src="https://pocket.tailwindui.com/_next/static/media/phone-frame.d4b6b62a.svg" width="366" height="729" decoding="async" data-nimg="1" class="pointer-events-none absolute inset-0 h-full w-full" loading="lazy" style="color:transparent">
                        </div>
                        <div class="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur sm:p-10"><svg viewBox="0 0 32 32" fill="none" aria-hidden="true" class="h-8 w-8">
                                <defs>
                                    <linearGradient id=":Rfm9m:-gradient" x1="14" y1="14.5" x2="7" y2="17" gradientUnits="userSpaceOnUse">
                                ...
                                <path d="M7 22c0-4.694 3.5-8 8-8" stroke="url(#:Rfm9m:-gradient)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="grid grid-cols-12 items-center gap-8 lg:gap-16 xl:gap-24">
                <div class="relative z-10 order-last col-span-6 space-y-6" role="tablist" aria-orientation="vertical">
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="absolute inset-0 bg-gray-800" data-projection-id="23" style="border-radius: 2.85714% / 7.69231%; transform: none; transform-origin: 50% 50% 0px;"></div>
                        <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                                <circle cx="16" cy="16" r="16" fill="#A3A3A3" fill-opacity="0.2"></circle>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M16 23a3 3 0 100-6 3 3 0 000 6zm-1 2a4 4 0 00-4 4v1a2 2 0 002 2h6a2 2 0 002-2v-1a4 4 0 00-4-4h-2z" fill="#737373"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5 4a4 4 0 014-4h14a4 4 0 014 4v24a4.002 4.002 0 01-3.01 3.877c-.535.136-.99-.325-.99-.877s.474-.98.959-1.244A2 2 0 0025 28V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9a2 2 0 00-2 2v24a2 2 0 001.041 1.756C8.525 30.02 9 30.448 9 31s-.455 1.013-.99.877A4.002 4.002 0 015 28V4z" fill="#A3A3A3"></path>
                            </svg>
                            <h3 class="mt-6 text-lg font-semibold text-white"><button class="text-left [:not(:focus-visible)]:focus:outline-none" id="headlessui-tabs-tab-:R2ir9m:" role="tab" type="button" aria-selected="true" tabindex="0" data-headlessui-state="selected" aria-controls="headlessui-tabs-panel-:r7:"><span class="absolute inset-0 rounded-2xl"></span>Invite friends for better returns</button></h3>
                            <p class="mt-2 text-sm text-gray-400">For every friend you invite to Pocket, you get insider notifications 5 seconds sooner. And it’s 10 seconds if you invite an insider.</p>
                        </div>
                    </div>
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                            ...
                            <h3 class="mt-6 text-lg font-semibold text-white">
                                <button class="text-left [:not(:focus-visible)]:focus:outline-none" id="headlessui-tabs-tab-:R2kr9m:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state=""><span class="absolute inset-0 rounded-2xl"></span>Notifications on stock dips</button></h3>
                            <p class="mt-2 text-sm text-gray-400">Get a push notification every time we find out something that’s going to lower the share price on your holdings so you can sell before the information hits the public markets.</p>
                        </div>
                    </div>
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="relative z-10 p-8">
                            <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" class="h-8 w-8">
                                ...
                                <circle cx="16" cy="16" r="16" fill="#A3A3A3" fill-opacity="0.2"></circle>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5 4a4 4 0 014-4h14a4 4 0 014 4v13h-2V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9a2 2 0 00-2 2v24a2 2 0 002 2h4v2H9a4 4 0 01-4-4V4z" fill="#A3A3A3"></path>
                                <path d="M7 22c0-4.694 3.5-8 8-8" stroke="url(#:R1mr9m:-gradient)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M21 20l.217-5.513a1.431 1.431 0 00-2.85-.226L17.5 21.5l-1.51-1.51a2.107 2.107 0 00-2.98 0 .024.024 0 00-.005.024l3.083 9.25A4 4 0 0019.883 32H25a4 4 0 004-4v-5a3 3 0 00-3-3h-5z" fill="#A3A3A3"></path>
                            </svg>
                            <h3 class="mt-6 text-lg font-semibold text-white">
                                <button class="text-left [:not(:focus-visible)]:focus:outline-none" id="headlessui-tabs-tab-:R2mr9m:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state="">
                                    <span class="absolute inset-0 rounded-2xl"></span>Invest what you want
                                </button>
                            </h3>
                            <p class="mt-2 text-sm text-gray-400">We hide your stock purchases behind thousands of anonymous trading accounts, so suspicious activity can never be traced back to you.</p>
                        </div>
                ...
                <div class="relative col-span-6">
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"><svg viewBox="0 0 558 558" width="558" height="558" fill="none" aria-hidden="true" class="animate-spin-slower">
                            <defs>
                    ...
                    <div class="relative aspect-[366/729] z-10 mx-auto w-full max-w-[366px]">
                        <div class="absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)] shadow-2xl"></div>
                        <div class="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                            <div class="col-start-1 row-start-1 flex focus:outline-offset-[32px] [:not(:focus-visible)]:focus:outline-none" id="headlessui-tabs-panel-:r7:" role="tabpanel" tabindex="0" data-headlessui-state="selected" aria-labelledby="headlessui-tabs-tab-:R2ir9m:">
                                <div class="flex flex-col w-full">
                                    <div class="flex justify-between px-4 pt-4">
                                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" class="h-6 w-6 flex-none">
                                            <path d="M5 6h14M5 18h14M5 12h14" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    ...
                                    <div class="mt-6 flex-auto rounded-t-2xl bg-white" style="opacity: 1; z-index: 1073741816; filter: blur(0px); transform: translateY(0%) scale(1) translateZ(0px);">
                                        <div class="px-4 py-6">
                                            <div class="space-y-6">
                                                <div>
                                                    <div class="text-sm text-gray-500">Full name</div>
