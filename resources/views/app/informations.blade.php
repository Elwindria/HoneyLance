    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col rounded-3xl bg-white gap-4 py-6 max-w-3xl px-4 sm:px-8">
            <div class="flex justify-between">
                <p class="text-king text-lg font-semibold indent-4">Actuellement</p>
            ...
            <div class="flex justify-between">
                ...
                <p class="text-emerald-600 font-medium">{{ number_format($this->objective_saving, 0, ',', ' ') }} €</p>
            </div>
            ...
            @else
                <div class="flex justify-between">
                    <p class="text-king text-lg font-semibold indent-4">Bonus</p>
                    <p class="text-emerald-600 font-medium">{{ number_format($this->still_need_objective_saving, 0, ',', ' ') }} €</p>
                </div>
            @endif
        </div>
