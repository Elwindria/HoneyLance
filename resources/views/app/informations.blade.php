<div class="max-h-screen md:max-w-7xl md:mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-2 px-2">
        ...
        <div class="flex flex-col gap-4 md:basis-1/2">
            <div class="mx-auto max-w-5xl pt-6 px-4 sm:px-8 flex justify-center">
            ...
            <div class="flex flex-col rounded-3xl bg-white gap-4 py-6 max-w-3xl px-4 sm:px-8 border-3 border-king/80 shadow">
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Epargne actuelle</p>
                ...
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Prévision <span class="text-xs text-king/50">pour la fin du mois</span></p>
                    <p class="{{ ($this->saving > 0) ? 'text-emerald-600' : 'text-red-600' }} font-medium">{{ number_format($this->saving, 0, ',', ' ') }} €</p>
                </div>
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Epargne moyenne gagnée <span class="text-xs text-king/50">par mois</span></p>
        ...
        <div class="flex flex-col gap-4 md:basis-1/2">
            ...
            <div class="flex flex-col rounded-3xl bg-white gap-4 py-6 max-w-3xl px-4 sm:px-8 border-3 border-king/80 shadow">
                <div class="flex justify-between">
                    <p class="text-king text-lg font-semibold ">Objectif <span class="text-xs text-king/50">6 mois de salaire</span></p>
                ...
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Encore</p>
                    <p class="text-red-600 font-medium">{{ number_format($this->still_need_objective_saving, 0, ',', ' ') }} €</p>
                </div>
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Estimation de temps <span class="text-xs text-king/50">en nombre de mois</span></p>
                ...
                @else
                <div class="flex justify-between items-center">
                    <p class="text-king text-lg font-semibold ">Objectif atteint - Bonus</p>
