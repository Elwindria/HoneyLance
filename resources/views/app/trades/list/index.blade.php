        ...
        <div class="relative rounded-t-3xl min-h-full bg-white" x-data="{scrollBackTop: false}" x-cloak>
            ...
            <div class="flex flex-col gap-4 mt-2 pt-6 pb-2 mb-2 mx-auto max-w-7xl px-4 sm:px-8 sticky top-0 bg-white rounded-t-3xl z-40">
                <div class="flex justify-center">
                    <div class="relative">
                        <input wire:model="search" class="block w-full appearance-none rounded-3xl pt-1 pb-2 border-honey border-2 h-8 bg-white focus:ring focus:ring-honey-light/50 focus:border-transparent text-king" placeholder="rechercher..." type="text" style="caret-color: rgb(107, 114, 128);" tabindex="0">
                ...
                <div class="flex justify-between">
                    <button wire:click="switchSummaryType('all')" class="text-king-light border-b border-king-light hover:text-honey px-3 py-2 font-medium text-sm">Tout ({{ $this->search }})</button>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-8 pb-12">
                ...
                @livewire('app.trade-list', ['page' => 1, 'perPage' => 10, 'key' => 'trades-page-' . 1, 'search' => $this->search])
