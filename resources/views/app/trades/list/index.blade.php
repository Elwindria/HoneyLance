    ...
    <div class="relative rounded-t-3xl md:rounded-b-3xl min-h-full bg-white" x-data="{scrollBackTop: false}" x-cloak>
        ...
        <div class="flex flex-col gap-4 mt-2 pt-6 pb-2 mb-2 mx-auto max-w-7xl px-4 sm:px-8 sticky -top-1 bg-white rounded-t-3xl z-40">
            <div class="flex justify-center">
                <div class="relative">
                    <input wire:model.debounce.500ms="search" class="block w-full text-center appearance-none rounded-3xl pt-1 pb-2 border-honey border-2 h-8 bg-white focus:ring focus:ring-honey-light/50 focus:border-transparent text-king" placeholder="rechercher..." type="search" style="caret-color: rgb(107, 114, 128);" tabindex="0">
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-8 pb-12 md:shadow-xl">
            ...
            <button class="fixed bottom-2 right-2 shadow-lg bg-honey-light p-2 rounded-full text-honey-dark" x-show="scrollBackTop" x-on:scroll.window="scrollBackTop = (window.pageYOffset > window.outerHeight * 0.5) ? true : false" @click.window="window.scrollTo({top: 0, behavior: 'smooth'})" x-transition.scale.origin.bottom aria-label="Back to top">
