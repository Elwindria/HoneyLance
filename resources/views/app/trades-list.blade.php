    ...
    <div class="relative rounded-t-3xl min-h-full bg-white">
        <div class="flex flex-col gap-4 mt-2 py-6 mx-auto max-w-7xl px-4 sm:px-8">
            <div class="flex justify-center">
                ...
                <div class="relative">
                    <input {{-- class="block w-full appearance-none bg-transparent py-4 pl-4 pr-12 text-base text-slate-900 placeholder:text-slate-600 focus:outline-none sm:text-sm sm:leading-6" --}} class="block w-full appearance-none rounded-3xl pt-1 pb-2 border-honey border-2 h-8 bg-white focus:ring focus:ring-honey-light/50 focus:border-transparent text-king" placeholder="rechercher..." type="text" style="caret-color: rgb(107, 114, 128);" tabindex="0">
